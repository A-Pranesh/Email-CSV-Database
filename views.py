...
def get(request, id=None):
    ...
    data = serialize.serialize("json", Student.objects.all())
    return HttpResponse(data)
...
def send_email(request):
    try:
        send_mail('Simple Mail',
                  'By opening this email you have been hacked you will be watched your photos and videos are all watched',
